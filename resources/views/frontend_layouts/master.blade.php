...
<head>
    ...
    <title>Batur Geopark - eCommerce</title>
                        ...
                        <div class="main_menu menu_three header_position">
                            <nav>
                                <ul>
                                    ...
                                    <li class="active"><a  href="index-2.html"><i class="zmdi zmdi-home"></i> home <i class="zmdi zmdi-caret-down"></i></a>
                                        <ul class="sub_menu">
        ...
        <div class="container">
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="newsletter_inner newsletter_three">
