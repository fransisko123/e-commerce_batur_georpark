...
@section('title', 'Edit Pemilik Toko')
...
@section('content')
    <div class="d-flex justify-content-between align-items-center">
      <h4 class="fw-bold py-3">
        <span class="text-muted fw-light"><a href="{{ route('pemilik_toko.index') }}">Pemilik Toko</a> /</span> Edit Pemilik Toko
      </h4>
    </div>
    ...
    <div class="p-4 sm:p-8 bg-white dark:bg-gray-800 shadow rounded mb-4">
      <div class="card-header d-flex justify-content-between align-items-center mb-3">
        <h5 class="mb-0">Form Edit Pemilik Toko</h5>
      </div>
      <div class="card-body mt-3">
        <form action="{{ route('pemilik_toko.update', $user->id) }}" method="post">
          @csrf
          @method('PUT') {{-- or use @method('PATCH') depending on your form --}}
          <div class="mb-3">
